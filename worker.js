...
async function handleRequest(request) {
  ...
  // ပြောင်းလဲမည့် ပရိုတိုကော အမျိုးအစားကို မှတ်မယ်
  const isTrojan = !!trojanParam;
  ...
  try {
    // ⚠️ အရေးကြီး - ဒီနေရာမှာ အစ်ကို့ GitHub Username နဲ့ Repo Name ကို ကွက်တိ ပြောင်းပေးပါ
    ...
    for (let s of sniList) {
      // VLESS ဆိုရင် encryption=none လိုပြီး Trojan ဆိုရင် မလိုပါ
...
// ၃။ နောက်ကွယ်မှာ သိမ်းထားမည့် HTML UI စနစ်
